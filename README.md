...
A comprehensive admin SPA designed dashboard application featuring embedded Looker Studio visualizations, role-based access control, interactive dashboards, training material management and builder, and enhanced security measures.
...
The primary purpose of developing this web viewer is to centralize all reports generated by our team in one accessible location. This eliminates the need for executives or administrators to browse through multiple Google Drive folders or search their emails to locate these reports. The goal is to streamline accessibility and improve user efficiency
